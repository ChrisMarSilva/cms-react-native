...
import useSendPayQrCodeCamera from '@/src/hooks/useSendPayQrCodeCamera'

export default function SendPayQrCodeCameraScreen() {
    const { hasCameraPermission, hasScanned, setHasScanned, handlSendQRCode } = useSendPayQrCodeCamera()
