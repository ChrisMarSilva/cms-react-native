...
export const createChave = async (urlDefault: string, ispb: string, tipoPessoa: string, documento: string, agencia: string, conta: string, tipoConta: string, nome: string, tipoChave: string, chave: string) => {
    try {
