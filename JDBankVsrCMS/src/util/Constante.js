...
export const URL_GERAR_QRCODE  = 'spi/api/qrcode/estatico/GerarQRCode'; 
export const URL_ENVIAR_QRCODE = 'api/qrcode'; 
export const URL_GET_CHAVE     = 'spi/api/chave'; 
export const URL_POST_CHAVE    = 'spi/api/chave'; 
export const URL_PAGAR_QRCODE  = 'api'; 
export const URL_GET_SALDO     = 'api/saldo'; 
...
export const URL_RECEBEDOR     = 'http://j3spi.azurewebsites.net/';
...
export const URL_PAGADOR       = 'http://jdspi.azurewebsites.net/';
